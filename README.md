...
```js
javascript:(function(){var script=document.createElement('script');script.src='//cdn.rawgit.com/adireddy/perf/7d0db02f750dba86984524bf06dbe6ce9fc1c65d/dist/perf.min.js';script.onload=function(){new Perf();};document.head.appendChild(script);})();
```
